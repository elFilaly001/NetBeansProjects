...
DefaultTableModel df ;
     ...
     */
    public recherche() throws Exception {
        initComponents();
    ...
    try {
        ...
        ResultSet r = con.createStatement().executeQuery("select * from article where prixachat = " +jTextField1.getText()+"");
        df.setRowCount(0);
        while(r.next()){
